...
public class InfoAttFileTypeEnum extends ValuedEnum {
     ...
     * 房客合同签名图片
     */
    private static final int LESSEE_SIGN = 31;
    /**
     * 房客合同签名图片
     */
    public static final InfoAttFileTypeEnum LESSEE_SIGN_ENUM = new InfoAttFileTypeEnum("房客合同签名图片", LESSEE_SIGN);
    /**
     * 房主合同签名图片
     */
    private static final int LESSOR_SIGN = 32;
    /**
     * 上传治安责任保证书
     */
    public static final InfoAttFileTypeEnum LESSOR_SIGN_ENUM = new InfoAttFileTypeEnum("房主合同签名图片", LESSOR_SIGN);
    /**
     * 上传治安责任保证书
     */
    private static final int SECURITY_BOOK_UPLOAD = 33;
    /**
     * 上传治安责任保证书
     */
    public static final InfoAttFileTypeEnum SECURITY_BOOK_UPLOAD_ENUM = new InfoAttFileTypeEnum("上传治安责任保证书", SECURITY_BOOK_UPLOAD);
